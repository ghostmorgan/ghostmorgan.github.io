...
* <a href="#3">3. Причины обострения проблемы обеспечения информационной безопасности</a>
* <a href="#4">4. Причины по которым проблема обеспечения безопасности автоматизированных систем относится к числу трудноразрешимых</a>
* <a href="#5">5. Риск информационной безопасности. Составляющие риска</a>
* <a href="#6">6. Анализ рисков и управление ими. Этапы анализа и управления</a>
* <a href="#7">7. Требования к методам оценки целесообразности затрат на обеспечение безопасности автоматизированных систем</a>
* <a href="#8">8. Категории затрат, связанных с безопасностью автоматизированных систем</a>
...
<h2><a name="3">3. Причины обострения проблемы обеспечения информационной безопасности</a></h2>
...
* Бурное развитие информационно-телекоммуникационных сетей ([**вот тут вы можете почитать интересную статистику по Интернету в России и в мире**](https://www.web-canape.ru/business/vsya-statistika-interneta-na-2019-god-v-mire-i-v-rossii/)).
...
<h2><a name="4">4. Причины по которым проблема обеспечения безопасности автоматизированных систем относится к числу трудноразрешимых</a></h2>
...
> *Все предыдущие выкладки были сделаны для того, чтобы дать чёткое представление о том, что невозможно создать абсолютно непреодолимую систему защиты информации. Это всегда стоить помнить в первую очередь и как специалисту по безопасности каждый раз напоминать своему руководству об этом. Нет единой концепции защиты информации, есть отдельные АС, есть то из чего они состоят, есть возможность использовать продукты, которые помогут снизить вероятность успешной реализации угрозы на отдельные объекты, составляющие данную АС.*

Специалисту по безопасности часто приходиться оперировать различными понятиями, определениями, поэтому необходимо грамотно представлять что это такое, когда о них заходит речь. Так вот и мы, постепенно будем себя приучать к ним.
...
![](//ghostmorgan.github.io/assets/images/ib/risk.svg "Стоимостная составляющая информационной безопасности")
...
<h2><a name="6">6. Анализ рисков и управление ими. Этапы анализа и управления</a></h2>
...
<h2><a name="7">7. Требования к методам оценки целесообразности затрат на обеспечение безопасности автоматизированных систем</a></h2>
...
<h2><a name="8">8. Категории затрат, связанных с безопасностью автоматизированных систем</a></h2>
...
[![railroad]({{ site.images | relative_url }}/ib/cat.png)]({{ site.images | relative_url }}/ib/cat.png)
